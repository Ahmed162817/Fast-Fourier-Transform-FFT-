vlib work
vlog Clock_Divider.v MAC.v Twiddle_factor_ROM.v FFT_32.v FFT_32_tb.sv +cover -covercells
...
coverage save FFT_32_tb.ucdb -onexit -du work.FFT_32
run -all
coverage exclude -du FFT_32 -togglenode j
coverage exclude -du FFT_32 -togglenode k
#quit -sim
#vcover report FFT_32_tb.ucdb -details -annotate -all -output FFT_Code_Coverage.txt